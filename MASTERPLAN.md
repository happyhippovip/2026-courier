...
- Stundenlange Werkzeug-Reparaturen während der Kernarbeit → Notlösung reicht.
...
- Courier startet und befüllt N Fenster/Worker automatisch mit Planer → Arbeiter → Prüfer.
- Jede Aufgabe genau einmal reserviert.
...
- Kunden sehen Fortschritt, Ergebnisse und gespeicherte, bereinigte Logs (Schlüssel/Tokens entfernt).
- Optional: per /clear geleerte Sitzungen speichern.
- **Abnahme:** Ein Testkunde startet per Doppelklick und sieht nur Fortschritt, Logs, Ergebnisse.

### Stufe 5 – Community
- Login mit X/Facebook, gemütlicher Chat, Vorführ-Ansicht mit Live-Logs.
...
| Tests beenden fremde Prozesse | Prozess-Kill-Regel in jedem Prompt |
...
## 9. Kontext-Block für neue Chats
```
...
- Diese Datei ist die **kanonische Roadmap**.
- Laufender technischer Zustand gehört in `docs/STATUS.md`.
- Agentenspezifische Arbeitsregeln gehören in `CLAUDE.md` und `AGENTS.md`.
- Förder-, Jobcenter-, Konto-, Abrechnungs- oder andere private Unterlagen gehören **nicht** in dieses öffentliche Repository.
