...
def main():
    ...
    server_state = Path("server/state/central_state.json").resolve()
    
    # We won't clear central_state.json to avoid destroying existing data.
    # We will just append to it and read it.
