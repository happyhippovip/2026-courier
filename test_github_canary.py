...
dispatch_a = f"dispatch-{uuid.uuid4().hex}"
...
plan = [
    {
        ...
        "artifacts": [f"courier_output_{dispatch_a}.json"],
        "capabilities": ["github"]
    },
    {
        "task_id": task_b_id,
...
resp = requests.post(f"{URL}/goals", json={"goal_text": "Final cross-worker physical acceptance", "client_id": "test", "workflow_plan": plan}, headers=HEADERS)
