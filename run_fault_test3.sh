...
python3 scripts/courier_founder_mode.py --goal "Create a file named events/reports/fault_test.txt containing exactly: HELLO" &
COURIER_PID=$!
echo "COURIER_PID=$COURIER_PID"

# Wait for the file to exist
while [ ! -f events/reports/fault_test.txt ]; do
