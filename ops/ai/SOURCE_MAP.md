...
BOUND_TO_CODE_HEAD: 0c8d1eddacb15dedbebb8406e475917dc2ab1c2b
...
TASK_RESULT: COMPONENT=canonical result ingestion FILE=server/app.py FUNCTION=task_result ROLE=identity validation + duplicate conflict semantics BOUND_TO_CODE_HEAD=0c8d1edd
...
PROVIDER_LOCK: COMPONENT=quota_backoff FILE=server/app.py FUNCTION=provider_wait/claim_task ROLE=server-owned quota-pool isolation BOUND_TO_CODE_HEAD=0c8d1edd
