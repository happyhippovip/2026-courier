...
task_id = "WINDOWS_CONTRACT_PROOF_1"
opp = {
    "opportunity_id": task_id,
    "source": "MAC_ANTIGRAVITY",
    "objective_id": "OBJ-WIN-CONTRACT",
    "project": "Courier",
    "description": "Prove that ACTION and SCOPE are derived from the routed task",
    "priority": 7,
