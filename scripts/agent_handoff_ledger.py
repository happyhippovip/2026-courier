...
def update(
    ...
    with writer_lock(path, timeout):
        ...
        if not has_physical_proof:
            ...
            physical_edges = {'FIRST PILOT - AUTHORIZED_MACHINE_ACTION', 'ONBOARD_FIRST_PILOT_CUSTOMER - SAFE_AUTOMATABLE_PREPARATION', 'PILOT INTAKE - SAFE_AUTOMATABLE_PREPARATION', 'EXTERNAL_PUBLICATION - SAFE_AUTOMATABLE_PREPARATION', 'PAYMENT ONLY WHEN ACTUALLY REQUIRED - IRREVERSIBLE_HUMAN_ACTION', 'EXTERNAL_PUBLICATION - IRREVERSIBLE_HUMAN_ACTION', 'EXTERNAL_PUBLICATION - AUTHORIZED_MACHINE_ACTION', 'PUBLIC DEPLOYMENT - AUTHORIZED_MACHINE_ACTION', 'RELEASE - IRREVERSIBLE_HUMAN_ACTION', 'PAYMENT ONLY WHEN ACTUALLY REQUIRED - AUTHORIZED_MACHINE_ACTION', 'ONBOARD_FIRST_PILOT_CUSTOMER - IRREVERSIBLE_HUMAN_ACTION', 'PUBLIC DEPLOYMENT - IRREVERSIBLE_HUMAN_ACTION', 'PILOT INTAKE - IRREVERSIBLE_HUMAN_ACTION', 'PILOT INTAKE - AUTHORIZED_MACHINE_ACTION', 'FIRST PILOT - IRREVERSIBLE_HUMAN_ACTION', 'ONBOARD_FIRST_PILOT_CUSTOMER - AUTHORIZED_MACHINE_ACTION', 'PAYMENT ONLY WHEN ACTUALLY REQUIRED - SAFE_AUTOMATABLE_PREPARATION', 'FIRST PILOT - SAFE_AUTOMATABLE_PREPARATION', 'PUBLIC DEPLOYMENT - SAFE_AUTOMATABLE_PREPARATION', 'PUBLICATION VERIFICATION', 'RELEASE - AUTHORIZED_MACHINE_ACTION', 'RELEASE - SAFE_AUTOMATABLE_PREPARATION', 'RELEASE', 'PUBLIC DEPLOYMENT', 'PUBLIC_DEPLOYMENT', 'FIRST PILOT', 'FIRST_PILOT', 'PILOT INTAKE', 'PILOT_INTAKE', 'SALES PACKAGE', 'SALES_PACKAGE', 'POST-PILOT HARDENING', 'POST_PILOT_HARDENING', 'EXTERNAL_PUBLICATION', 'PAYMENT ONLY WHEN ACTUALLY REQUIRED', 'PAYMENT_ONLY_WHEN_ACTUALLY_REQUIRED', 'ONBOARD_FIRST_PILOT_CUSTOMER'}
