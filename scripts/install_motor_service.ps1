...
$action = "Create"
$taskName = "CourierMotor"
$scriptPath = "$PSScriptRoot\start_motor.bat"
...
Write-Host "Courier Motor scheduled task registered to start on boot with restart throttling."
