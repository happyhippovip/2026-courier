...
task_id = "WINDOWS_OVERNIGHT_TEST_1"
opp = {
    "opportunity_id": task_id,
    "source": "MAC_ANTIGRAVITY",
    "objective_id": "OBJ-OVERNIGHT",
    "project": "Courier",
    "description": "Run Windows validation script Test-WindowsAIHost.ps1",
    "priority": 7,
