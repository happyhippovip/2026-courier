...
def generate_state():
    with open(state_file, "w", newline="") as f:
        ...
        # Ensure wid is the second column to preserve VISIBLE MODE backward compatibility
        writer.writerow(["slot_id", "wid", "provider/account", "pid", "tty/pty", "task_id", "scope", "state", "updated_at", "proof_ref", "next_action", "blocker"])
