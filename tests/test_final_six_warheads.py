...
def test_warhead_a_false_external_success():
    ...
    unauthorized_edges = [
        ...
        ("SALES PACKAGE", "UNVERIFIED_EXTERNAL_EFFECT_SALES PACKAGE"),
        ("SALES_PACKAGE", "UNVERIFIED_EXTERNAL_EFFECT_SALES_PACKAGE"),
        ("POST-PILOT HARDENING", "UNVERIFIED_EXTERNAL_EFFECT_POST-PILOT HARDENING"),
        ("POST_PILOT_HARDENING", "UNVERIFIED_EXTERNAL_EFFECT_POST_PILOT_HARDENING"),
