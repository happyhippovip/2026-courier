...
def test_gemini_worker_adapter_timeout(tmp_path):
    task_file = tmp_path / "dummy_task_timeout.json"
    with open(task_file, "w") as f:
    ...
    # The first communicate raises TimeoutExpired, the second returns normal data
