...
def test_restart_resume_torture(tmp_path):
    ...
    ledger_path = setup_ledger(
        ...
        proven_edges=[
            ...
            'RELEASE - SAFE_AUTOMATABLE_PREPARATION', 'RELEASE - AUTHORIZED_MACHINE_ACTION', 
            ...
            'PILOT INTAKE - AUTHORIZED_MACHINE_ACTION', 'PILOT INTAKE - IRREVERSIBLE_HUMAN_ACTION', 
            'SALES PACKAGE', 'FIRST PILOT - SAFE_AUTOMATABLE_PREPARATION', 
            'FIRST PILOT - AUTHORIZED_MACHINE_ACTION', 'FIRST PILOT - IRREVERSIBLE_HUMAN_ACTION', 
            ...
            'POST-PILOT HARDENING', 'EXTERNAL_PUBLICATION - AUTHORIZED_MACHINE_ACTION', 
