...
def cmd_version(args):
    ...
    if getattr(args, "json", False):
        ...
        return
    print("=======================================================")
    print(f"  {vinfo['product']} ({vinfo['release_tag']})")
    print("=======================================================")
    print(f"PRODUCT              : {vinfo['product']}")
    print(f"VERSION              : {vinfo['version']}")
    print(f"BUILD_ID             : {vinfo['build_id']}")
    print(f"GIT_SHA              : {vinfo['git_sha']}")
    print(f"PYTHON_VERSION       : {vinfo['python_version']}")
    print(f"SCHEMA_VERSION       : {vinfo['schema_version']}")
    print(f"CONSTITUTION_VERSION : {vinfo['constitution_version']}")
    const = vinfo.get("constitution", {})
    print(f"Constitution Status  : {const.get('status', 'NOT_FOUND')} (Authority: {const.get('canonical_authority', 'N/A')})")
    print("=======================================================")
