...
const { FollowUpInbox, FOLLOW_UP_STATUS } = require('../../scratch/rc3_hardening_lab/follow_up_inbox');
const { BorderGuard, OUTBOUND_DECISION, WORKER_RESPONSE } = require('../../scratch/rc3_hardening_lab/border_guard_contract');
