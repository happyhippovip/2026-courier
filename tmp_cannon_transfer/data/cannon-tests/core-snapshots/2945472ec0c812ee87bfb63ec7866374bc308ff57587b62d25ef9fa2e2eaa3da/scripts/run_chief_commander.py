...
class SmartResourceRouter:
    ...
    def classify_and_route(task_desc: str, scope_files: list[str], context_delta: dict | None = None) -> tuple[str, str, str]:
        ...
        # Enforce quota protection: Heavy work, media, 3D, UI, creative, and planning go to platform_neutral
        ...
        # Default to platform_neutral for all implementation
        return (
            "platform_neutral",
            "Default generic worker (Quota Protection active for Codex)",
            "DETERMINISTIC_ANTIGRAVITY"
        )
